...
# WidgetNodeType enumerates the renderable node types for agent widget trees.
# Manually maintained: this enum was removed from the gotypegen source but is
# part of the SDK's public API surface.
