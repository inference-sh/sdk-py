...
def test_interrupt_resource_type_values(member, value):
    """InterruptDTO.resource_type uses InterruptResourceType (12eeed3 trigger enhancements)."""
...
def test_interrupt_dto_resource_type_field():
    """InterruptDTO.resource_type is typed to InterruptResourceType, not bare str (12eeed3)."""
